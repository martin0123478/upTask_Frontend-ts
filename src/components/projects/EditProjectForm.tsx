...
export default function EditProjectForm({ data }: EditProjectFormProps) {
    ...
    const { mutate } = useMutation({
        ...
        onSuccess: (data) => {
            ...
            querryClient.invalidateQueries({ queryKey: ['editProject', projectId] })
            toast.success(data)
            navigate('/')
    ...
    return (
        <>
            <div className="max-w-3xl mx-auto">
                ...
                <p className="text-2xl font-light text-gray-500 mt-5">Llena el siguiete formulario para editar el proyecto</p>
                <nav className="my-5">
